...
class DashcamNode(Node):
    def __init__(self):
        ...
        self.video_path = "/home/samuel/Documents/rse_with_ros2/lesson1/dash1.mp4"
        ...
        # Load the pretrained YOLO model – update the model weights path if needed
        ...
        # # Create a service for getting class counts
    ...
    #         class_count_array.counts.append(self._create_class_count(class_name, count))
            
    #     self.class_count_pub.publish(class_count_array)
    #     self.get_logger().info(f"Published class count array: {class_count_array}")
